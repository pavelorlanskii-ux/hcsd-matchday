...
export const matchday = {
  ...
  highlight: {
    ...
    badge: "Перед стартом",
    description:
      "Музыкальное вступление, которое задает настроение всей СКА Арене. Приходите заранее, чтобы услышать живое исполнение до стартового вбрасывания.",
    image: "/next.svg",
  },
  filters: {
  ...
  activities: [
    ...
    },
    {
      ...
      description: "Соберите плакат прямо на СКА Арене: слоганы, наклейки и яркие маркеры. Лучшие попадут в кадры и на экраны.",
      location: "Фойе стадиона",
      badges: ["До матча"],
      tags: ["Фото"],
